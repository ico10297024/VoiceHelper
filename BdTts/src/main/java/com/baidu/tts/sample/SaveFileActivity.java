...
public class SaveFileActivity extends SynthActivity {
    ...
    public SaveFileActivity(Activity activity, Handler handler) {
    ...
    protected void initialTts() {
        String tmpDir = FileUtil.createTmpDir(mActivity);
        // 设置初始化参数
        ...
        synthesizer = new MySyntherizer(mActivity, initConfig, mainHandler); // 此处可以改为MySyntherizer 了解调用过程
    }
}
