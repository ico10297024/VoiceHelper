...
public class SynthActivity extends BaseActivity {
    ...
    public SynthActivity(Activity activity, Handler handler) {
    ...
    public void switchRes() {
        // 切换离线资源
        AlertDialog.Builder builder = new AlertDialog.Builder(mActivity, android.R.style.Theme_Holo_Light_Dialog);
